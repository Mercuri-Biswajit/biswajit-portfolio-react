 ...
 */
function calcRCCRate(cementBags, steelKg, labourDaysPerCum, rates, labourCostPerDay) {
  return (
 ...
 */
function createBrickworkItem(srNo, totalArea, materialQty, rates, labourCostPerDay) {
 ...
 */
function createFlooringItem(srNo, totalArea, materialQty, rates, labourCostPerDay) {
 ...
 */
function createPaintingItem(srNo, totalArea, materialQty, rates, labourCostPerDay) {
