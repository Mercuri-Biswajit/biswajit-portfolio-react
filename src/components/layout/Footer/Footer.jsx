        ...
        <div className="footer-main">
          ...
          <div className="footer-connect-col">
            ...
            <div className="footer-connect-list">
              <a href={SITE.linkedin} target="_blank" rel="noreferrer" className="footer-connect-item" aria-label="LinkedIn Profile">
              ...
              <a href={SITE.facebook} target="_blank" rel="noreferrer" className="footer-connect-item" aria-label="Facebook Profile">
                <span className="footer-connect-icon">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href={SITE.instagram} target="_blank" rel="noreferrer" className="footer-connect-item" aria-label="Instagram Profile">
                <span className="footer-connect-icon">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
