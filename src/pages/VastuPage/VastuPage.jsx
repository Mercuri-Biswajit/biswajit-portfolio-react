            ...
            {isLoading ? (
              <div className="vastu-skeleton">
                ...
                <div className="vastu-skeleton-card">
                  <SkeletonBlock width="180px" height="1.1rem" borderRadius="4px" style={{ marginBottom: "2rem" }} />
                  <div className="vastu-skeleton-inputs">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="vastu-skeleton-input-group">
                        <SkeletonBlock width="120px" height="0.8rem" borderRadius="3px" style={{ marginBottom: "0.5rem" }} />
                        <SkeletonBlock width="100%" height="46px" borderRadius="8px" />
                      </div>
                    ))}
                  </div>
                  <SkeletonBlock width="160px" height="46px" borderRadius="30px" style={{ margin: "2rem auto 0", display: "block" }} />
                </div>
                {/* Layout preview skeleton */}
                <div className="vastu-skeleton-layout">
                  <SkeletonBlock width="100%" height="360px" borderRadius="12px" />
                </div>
              </div>
            ) : (
              <VastuRoomPlanner />
              ...
              <div className="vastu-skeleton-study">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="vastu-skeleton-study-card">
                    <SkeletonBlock width="48px" height="48px" borderRadius="50%" style={{ marginBottom: "1rem" }} />
                    <SkeletonBlock width="60%" height="1rem" borderRadius="4px" style={{ marginBottom: "0.75rem" }} />
                    <SkeletonBlock width="100%" height="0.8rem" borderRadius="3px" style={{ marginBottom: "0.4rem" }} />
                    <SkeletonBlock width="85%" height="0.8rem" borderRadius="3px" style={{ marginBottom: "0.4rem" }} />
                    <SkeletonBlock width="90%" height="0.8rem" borderRadius="3px" />
                  </div>
                ))}
              </div>
            </div>
