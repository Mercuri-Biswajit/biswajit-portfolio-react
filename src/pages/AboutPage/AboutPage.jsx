        ...
        <div className="container">
          ...
          <div className="contact-content" data-aos="fade-up" data-aos-delay="200">
            <div className="contact-intro">
              <p>
                Have a project in mind? Whether you need structural design, cost estimation, 
                or architectural planning, I'm here to help bring your vision to life. 
                Get in touch and let's discuss how we can work together.
              </p>
            </div>

            <div className="contact-methods">
              <div className="contact-method" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div className="contact-method" data-aos="zoom-in" data-aos-delay="200">
                <div className="method-icon">📱</div>
              ...
              <div className="contact-method" data-aos="zoom-in" data-aos-delay="300">
                <div className="method-icon">💼</div>
            ...
            <div className="contact-availability" data-aos="fade-up" data-aos-delay="500">
